OC.L10N.register(
    ...
    "OAuth instance URL" : "URL istanza OAuth",
    ...
    "Connected to {url} as {displayname} ({name})" : "Connesso a {url} come {displayname} ({name})",
    ...
    "created {relativeDate}" : "creato {relativeDate}",
    "closed {relativeDate}" : "chiuso{relativeDate}",
    "updated {relativeDate}" : "aggiornato {relativeDate}",
    "Comment from @{username}" : "Commento da @{username}",
    "Assigned to {username}" : "Assegnato a {username}",
    "GitLab API error" : "Errore API di GitLab",
