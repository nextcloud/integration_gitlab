OC.L10N.register(
    ...
    "Restrict GitLab instance URL" : "限制 GitLab 實例的 URL",
    ...
    "Account added" : "已添加帳戶",
    "Failed to add account" : "無法添加帳戶",
    "Account deleted" : "已刪除帳戶",
    "Failed to delete account" : "無法刪除帳戶",
    "GitLab options saved" : "已儲存 GitLab 選項",
    "Failed to save GitLab options" : "儲存 GitLab 選項失敗",
    "Failed to get GitLab projects" : "未能獲取 GitLab 專案",
    "Failed to get GitLab groups" : "無法獲取 GitLab 群組",
    "Selected account filters updated" : "已選擇帳戶過濾器更新了",
    "Failed to update GitLab filters" : "無法更新 Gitlab 過濾器",
    "Connect to GitLab using OAuth" : "使用 OAuth 連結至 GitLab",
    "OAuth instance URL" : "OAuth 實例的 URL",
    "GitLab instance address" : "GitLab 站台地址",
    "enforced by administrator" : "已被管理員實施",
    ...
    "Connected to {url} as {displayname} ({name})" : "以 {displayname}（{name}）連結至 {url} ",
    "Remove account" : "刪除帳戶",
    ...
    "Gitlab Account for Dashboard widget" : "儀表板小工具的 GitLab 帳戶",
    "Projects filter for widget" : "小工具的項目過濾器",
    "Groups filter for widget" : "群組的項目過濾器",
    ...
    "Unknown error" : "錯誤不詳",
    "GitLab connected accounts settings" : "GitLab 連接帳戶設定",
