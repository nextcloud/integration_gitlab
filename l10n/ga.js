OC.L10N.register(
    ...
    "Give \"read_user\", \"read_api\" and \"read_repository\" permissions to the application." : "Tabhair ceadanna \"read_user\", \"read_api\" agus \"read_repository\" don fheidhmchlár.",
    ...
    "Restrict GitLab instance URL" : "Srian a chur ar URL sampla GitLab",
    ...
    "{url} as {displayname} ({name})" : "{url} mar {displayname} ({name})",
    "Account added" : "Cuntas curtha leis",
    "Failed to add account" : "Theip ar an gcuntas a chur leis",
    "Account deleted" : "Scriosadh an cuntas",
    "Failed to delete account" : "Theip ar scriosadh an chuntais",
    "GitLab options saved" : "Roghanna GitLab sábháilte",
    "Failed to save GitLab options" : "Theip ar shábháil roghanna GitLab",
    "Failed to get GitLab projects" : "Theip ar thionscadail GitLab a fháil",
    "Failed to get GitLab groups" : "Theip ar ghrúpaí GitLab a fháil",
    "Selected account filters updated" : "Scagairí cuntais roghnaithe nuashonraithe",
    "Failed to update GitLab filters" : "Theip ar scagairí GitLab a nuashonrú",
    "Connect to GitLab using OAuth" : "Ceangail le GitLab ag úsáid OAuth",
    "OAuth instance URL" : "URL sampla OAuth",
    "GitLab instance address" : "Seoladh shamplach GitLab",
    "enforced by administrator" : "curtha i bhfeidhm ag an riarthóir",
    "Personal access token" : "Comhartha rochtana pearsanta",
    "GitLab personal access token" : "Comhartha rochtana pearsanta GitLab",
    "Give the token the \"read_user\", \"read_api\" and \"read_repository\" permissions." : "Tabhair na ceadanna \"read_user\", \"read_api\" agus \"read_repository\" don chomhartha.",
    "Connect to GitLab using Personal Access Token" : "Ceangail le GitLab ag baint úsáide as Personal Access Token",
    "Connected to {url} as {displayname} ({name})" : "Ceangailte le {url} mar {displayname} ({name})",
    ...
    "Please use the External Sites app to add GitLab to your navigation bar:" : "Bain úsáid as an aip Shuíomhanna Seachtracha chun GitLab a chur le do bharra nascleanúna:",
    ...
    "Gitlab Account for Dashboard widget" : "Giuirléid Cuntas Gitlab don Deais",
    "Projects filter for widget" : "Scagaire tionscadal le haghaidh giuirléid",
    "Groups filter for widget" : "Scagaire grúpaí le haghaidh giuirléid",
