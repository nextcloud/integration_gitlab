OC.L10N.register(
    ...
    "Put the \"Application ID\" and \"Application secret\" below. Your Nextcloud users will then see a \"Connect to GitLab\" button in their personal settings if they select the GitLab instance defined here." : "Engada deseguido o «ID de cliente» e o «Segredo de cliente». Os seus usuarios de Nextcloud verán entón un botón «Conectar con GitLab» nos seus axustes persoais se seleccionan a instancia GitLab aquí definida.",
    ...
    "When you create an access token yourself, give it at least \"read_user\", \"read_api\" and \"read_repository\" permissions. Optionally \"api\" instead." : "Cando vostede cree un testemuño de acceso, déalle polo menos os permisos «read_user», «read_api» e «read_repository». Opcionalmente «api» no seu lugar.",
