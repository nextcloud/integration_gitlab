OC.L10N.register(
    ...
    "GitLab repositories, issues and merge requests" : "Repozitáře, hlášení problémů a požadavky na začlenění na GitLab",
    "GitLab issues" : "Hlášení problémů z GitLab",
    "GitLab merge requests" : "Požadavky na začlenění z GitLab",
    ...
    "Give \"read_user\", \"read_api\" and \"read_repository\" permissions to the application." : "Udělte aplikaci oprávnění „read_user“ a „read_repository“.",
    ...
    "Restrict GitLab instance URL" : "Omezit URL GitLab instance",
    ...
    "{url} as {displayname} ({name})" : "{url} jako {displayname} ({name})",
    ...
    "Failed to get GitLab projects" : "Nepodařilo se získat GitLab projekty",
    "Failed to get GitLab groups" : "Nepodařilo se získat GitLab skupiny",
    "Selected account filters updated" : "Vybrané filtry účtů zaktualizovány",
    "Failed to update GitLab filters" : "Nepodařilo se zaktualizovat GitLab filtry",
    "Connect to GitLab using OAuth" : "Připojit ke GitLab pomocí OAuth",
    "OAuth instance URL" : "URL adresa instance OAuth",
    "GitLab instance address" : "Adresa instance GitLab",
    "enforced by administrator" : "vynuceno správcem",
    "Personal access token" : "Osobní přístupový token",
    "GitLab personal access token" : "GitLab osobní přístupový token",
    "Give the token the \"read_user\", \"read_api\" and \"read_repository\" permissions." : "Udělte tokenu oprávnění pro „read_user“, „read_api“ a „read_repository“.",
    "Connect to GitLab using Personal Access Token" : "Připojit se ke GitLab pomocí osobního přístupového tokenu",
    "Connected to {url} as {displayname} ({name})" : "Připojeni k {url} jako {displayname} ({name}) ",
    ...
    "Please use the External Sites app to add GitLab to your navigation bar:" : "Pro přidání GitLab do pruhu navigace použijte aplikaci Externí weby:",
    ...
    "Projects filter for widget" : "Filtr projektů pro ovládací prvek",
    "Groups filter for widget" : "Filtr skupin pro ovládací prvek",
    ...
    "Closed merge request" : "Uzavřený požadavek na načlenění",
    "Merged merge request" : "Začleněný požadavek na začlenění",
    ...
    "Comment from @{username}" : "Komentář od @{username}",
    "Assigned to {username}" : "Přiděleno {username}",
    "GitLab API error" : "Chyba GitLab API",
    "Unknown error" : "Neznámá chyba",
    "GitLab connected accounts settings" : "Nastavení pro propojený účet na GitLab",
    "by {creator}" : "od {creator}",
    "CLOSED" : "UZAVŘENO",
    "MERGED" : "ZAČLENĚNO",
    "Upvotes" : "Hlasů pro",
    "Downvotes" : "Hlasů proti",
    "Comments" : "Komentáře",
    "Author" : "Autor",
    "Owner" : "Vlastník",
