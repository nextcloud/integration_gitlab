OC.L10N.register(
    ...
    "GitLab repositories, issues and merge requests" : "Репозитории GitLab, проблемы и запросы на слияние",
    "GitLab merge requests" : "Запросы на слияние GitLab",
    ...
    "Assigned to {username}" : "Назначено на {username}",
    "Unknown error" : "Неизвестная ошибка",
    "GitLab connected accounts settings" : "Настройки подключенных аккаунтов GitLab",
