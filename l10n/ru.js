OC.L10N.register(
    ...
    "GitLab integration" : "Интерграция GitLab",
    "Integration of GitLab software development management service" : "Интеграция службы управления разработкой программного обеспечения GitLab",
    ...
    "and give \"api\", \"read_user\", \"read_api\" and \"read_repository\" permissions to the application." : "и предоставьте приложению разрешения api, read_user, read_api и read_repository.",
    ...
    "When you create an access token yourself, give it at least \"api\", \"read_user\", \"read_api\" and \"read_repository\" permissions." : "Когда вы создаете токен доступа самостоятельно, дайте ему как минимум разрешения «api», «read_user», «read_api» и «read_repository».",
    ...
    "Connect to GitLab" : "Подключиться к GitLab",
    "Connected as {user}" : "Подключено под именем {user}",
    "Disconnect from GitLab" : "Отключиться от GitLab",
    "Enable searching for repositories" : "Включить поиск репозиториев",
    "Enable searching for issues and merge requests" : "Включение поиска проблем и запросов на слияние",
    "(This may be slow or even fail on some GitLab instances)" : "(Это может быть медленным или даже ошибочным на некоторых серверах GitLab)",
    ...
    "Error connecting to GitLab" : "Ошибка подключения к GitLab",
    "No GitLab notifications!" : "Нет уведомлений GitLab!",
    "Failed to get GitLab notifications" : "Не удалось получить уведомления GitLab",
    ...
    "Failed to edit GitLab todo" : "Не удалось изменить задачу GitLab"
},
