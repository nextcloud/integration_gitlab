OC.L10N.register(
    ...
    "GitLab repositories" : "Αποθήκες GitLab",
    ...
    "and give \"api\", \"read_user\", \"read_api\" and \"read_repository\" permissions to the application." : "και δώστε δικαιώματα \"api\", \"read_user\", \"read_api\" και \"read_repository\" στην εφαρμογή.",
    ...
    "OAuth app instance address" : "Διεύθυνση παρουσίας εφαρμογής OAuth",
    ...
    "When you create an access token yourself, give it at least \"api\", \"read_user\", \"read_api\" and \"read_repository\" permissions." : "Όταν δημιουργείτε μόνοι σας ένα διακριτικό πρόσβασης, δώστε του τουλάχιστον δικαιώματα \"api\", \"read_user\", \"read_api\" και \"read_repository\".",
    "GitLab instance address" : "Διεύθυνση παρουσίας GitLab",
    "Personal access token" : "Διακριτικό προσωπικής πρόσβασης",
    "GitLab personal access token" : "Διακριτικό προσωπικής πρόσβασης GitLab",
    "Connect to GitLab" : "Συνδεθείτε στο GitLab",
    ...
    "(This may be slow or even fail on some GitLab instances)" : "(Αυτό μπορεί να είναι αργό ή ακόμη και να αποτύχει σε ορισμένες περιπτώσεις του GitLab)",
